...
form.addEventListener("submit", (e) => {
    if (!(validUserName==true && validEmail==true && validAddress==true && validPhone==true && validPassword==true && confirmPassword==true && validDateOfBirth==true && validDegree==true && validSpeciality==true)) {
        e.preventDefault();
